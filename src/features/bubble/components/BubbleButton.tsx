      ...
      <Show when={isNotDefined(props.customIconSrc)} keyed>
        <img
          ...
          class={
            ...
            (props.isBotOpened ? 'scale-0 opacity-0' : 'scale-100 opacity-100') +
            (props.size === 'large' ? ' w-9 h-9' : ' w-7 h-7') // Adjust size as needed
          }
          style={{
            stroke: props.iconColor ?? defaultIconColor, // This style may not be relevant for an image and can be adjusted or removed
          }}
